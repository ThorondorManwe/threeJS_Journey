...
cubeTweaks.addColor(debugObject, 'color').name('color').onChange(() => {material.color.set(debugObject.color)});
...
cubeTweaks.add(debugObject, 'subdivision').min(0).max(10).step(1).name('subdivision').onFinishChange(() => {
